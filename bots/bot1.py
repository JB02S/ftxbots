...
class Bot:
    ...
    def __init__(self):
        ...
        self.botInfo = [input("Most recent type of confirmation signal? UT or DT?"), input("Trend catcher state? CD for red or CU for green.")]
    ...
    def update(self, data):
        ...
        if (self.tradingViewInfo[1] == "UT" or self.tradingViewInfo[1] == "ES") and client.get_positions()[0]['size'] < 0:
